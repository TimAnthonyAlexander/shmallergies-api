...
<head>
    ...
    <title>Shmallergies API Documentation</title>
    ...
    <script>
        var tryItOutBaseUrl = "http://shmallergies.test";
        var useCsrf = Boolean();
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-ping">Return a ping response</a>
                            </li>
...
<aside>
    <strong>Base URL</strong>: <code>http://shmallergies.test</code>
</aside>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-ping">Return a ping response</h2>
...
<div class="bash-example">
    ...
    --get "http://shmallergies.test/api/ping" \
...
<div class="javascript-example">
    ...
    "http://shmallergies.test/api/ping"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://shmallergies.test/api/user" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://shmallergies.test/api/user"
);
